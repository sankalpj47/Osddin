...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  return (
    <style
      // biome-ignore lint/security/noDangerouslySetInnerHtml: As per shadcn
...
function ChartTooltip(props: RechartsPrimitive.TooltipProps<ValueType, NameType>) {
...
function ChartLegend(props: RechartsPrimitive.LegendProps) {
