...
import { CheckIcon, ChevronLeftIcon, ChevronRightIcon, CopyIcon, PaperclipIcon, XIcon } from 'lucide-react';
...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      'is-user:dark flex w-fit flex-col gap-2 overflow-hidden rounded px-4 py-3 text-sm',
...
export const MessageCopyAction = ({ text, ...props }: { text: string } & Omit<MessageActionProps, 'children'>) => {
...
// biome-ignore lint/style/useComponentExportOnlyModules: export needed
