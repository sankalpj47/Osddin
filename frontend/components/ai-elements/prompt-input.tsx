/** biome-ignore-all lint/style/useComponentExportOnlyModules: necessary */
/** biome-ignore-all lint/suspicious/noExplicitAny: for speech recognition */
'use client';
...
export const PromptInputTextarea = ({
  ...
  return (
    <InputGroupTextarea
      className={cn('field-sizing-content max-h-36 min-h-12', className)}
      name='message'
