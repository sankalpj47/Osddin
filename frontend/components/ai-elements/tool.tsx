...
export const ToolOutput = ({ className, output, errorText, ...props }: ToolOutputProps) => {
  ...
  // Check if output is a screenshot (image data)
  if (
    output &&
    ...
    Output = (
      <div className='flex flex-col gap-2'>
        <Image
          src={`data:image/png;base64,${output[0].data}`}
          alt='Graph Screenshot'
          className='max-w-full rounded-md border'
          width={200}
          height={200}
        />
        <p className='text-muted-foreground text-xs'>Screenshot captured successfully</p>
      </div>
    );
