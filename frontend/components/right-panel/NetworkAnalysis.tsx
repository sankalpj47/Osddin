            ...
            <DialogContent className="flex max-h-[90vh] min-h-[60vh] max-w-6xl flex-col gap-4 p-6 rounded-2xl border border-gray-200 bg-white shadow-2xl">
              ...
              <Tabs defaultValue="table" className="w-full flex-1 flex flex-col min-h-0">
                <TabsList className="grid w-64 grid-cols-2 rounded-xl bg-gray-100 p-1 self-center mb-4">
                  <TabsTrigger className="rounded-lg py-1.5 text-xs font-semibold data-[state=active]:bg-white data-[state=active]:text-gray-900 data-[state=active]:shadow-xs" value="table">Table View</TabsTrigger>
                  <TabsTrigger className="rounded-lg py-1.5 text-xs font-semibold data-[state=active]:bg-white data-[state=active]:text-gray-900 data-[state=active]:shadow-xs" value="chart">Chart View</TabsTrigger>
                </TabsList>
                
                <TabsContent value="table" className="flex-1 min-h-0 focus-visible:outline-none data-[state=inactive]:hidden flex flex-col">
                ...
                <TabsContent value="chart" className="flex-1 focus-visible:outline-none data-[state=inactive]:hidden grid grid-cols-3 gap-6 items-center min-h-0">
                  <div className="col-span-1 space-y-2.5 rounded-xl border border-gray-100 bg-gray-50/50 p-4">
                    <h5 className="text-xs font-bold text-gray-800 uppercase tracking-wider mb-1.5">Partition Metadata</h5>
                    ...
                    <p className="text-[10px] leading-normal text-gray-400 italic mt-4">* Hover over specific pie slices to map targeted community density characteristics.</p>
                  </div>
              ...
              <DialogFooter className="border-t border-gray-100 pt-3 gap-2 flex items-center justify-end">
                <Button variant="outline" size="sm" onClick={() => handleExport(algorithmResults.communities)} className="h-9 font-semibold gap-2 border-gray-200 text-gray-700 hover:bg-gray-50 rounded-lg">
                  Export Dataset (.CSV)
                </Button>
                <DialogClose asChild>
                  <Button type="button" variant="secondary" onClick={() => setShowTable(false)} className="h-9 font-semibold rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-700">
                    Close Sheet
                  </Button>
                </DialogClose>
              </DialogFooter>
