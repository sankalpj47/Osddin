...
> [!NOTE]
> This project takes environment variables from a `.env` file. You can create a `.env` file in the root of the project and edit the environment variables mentioned in the [`.env.example`](.env.example) file.:
